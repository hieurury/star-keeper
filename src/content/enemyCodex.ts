...
export const ENEMY_CODEX: EnemyCodexEntry[] = [
  ...
  },
  {
    ...
    name: 'Dnox - Hoả chủng',
    icon: 'PhFire',
    info: 'Đơn vị chịu đòn với khả năng hấp thụ sát thương để tích tụ nhiệt độ.',
    attackPattern: 'Sạc nhiệt theo lượng HP mất đi. Khi đạt cực đại (Màu Lam), nó sẽ phóng hoả cầu thiêu rụi khu vực bên dưới.',
    counters: 'Hoả cầu sạc tỉ lệ thuận với sát thương nó nhận. Càng đánh nhanh, nó bắn càng sớm.',
    expDrop: '2-3 orb tím/xanh (~40-60 EXP).',
    tips: [
      'Ngừng bắn hoặc né hẳn sang một bên khi nó bắt đầu chớp sáng màu lam.',
      'Hoả cầu có thể hồi máu cho nó nếu trúng phi cơ của bạn.',
    ],
    stats: { hp: 95, speed: 16, damage: 70, threat: 68 },
    phases: [
      { title: 'Tích nhiệt', desc: 'Chuyển đổi từ Đỏ -> Cam -> Lam khi nhận sát thương.', art: 'dnox_fire_charge' },
      { title: 'Hoả cầu', desc: 'Phóng luồng lửa thẳng xuống trục Y.', art: 'dnox_fire_blast' },
    ],
  },
  {
    kind: 'dnox_ice',
    ...
    name: 'Dnox - Băng lam',
    icon: 'PhSnowflake',
    info: 'Quái tầm trung xả đạn làm chậm và đóng băng hệ thống điều khiển.',
    attackPattern: 'Bắn đạn tinh thể băng găm vào phi cơ. Trúng 1 viên gây Tê Cóng, trúng 2 viên sẽ Đóng Băng hoàn toàn.',
    counters: 'Người chơi bị đóng băng sẽ không thể di chuyển hay bắn đạn.',
    expDrop: '2-4 orb xanh/tím (~40-70 EXP).',
    tips: [
      'Không bao giờ để bị trúng viên đạn băng thứ hai.',
      'Nhấp (Tap) liên tục vào màn hình 5 lần để phá vỡ lớp băng nhanh hơn.',
    ],
    stats: { hp: 42, speed: 45, damage: 20, threat: 74 },
    phases: [
      { title: 'Tê cóng', desc: 'Đạn băng găm vào thuyền, chờ phát thứ hai.', art: 'dnox_ice_frost' },
      { title: 'Đóng băng', desc: 'Kết liễu hệ thống di chuyển tạm thời.', art: 'dnox_ice_freeze' },
    ],
  },
  {
    kind: 'dnox_soil',
    tab: 'minion',
    name: 'Dnox - Thổ nhưỡng',
    icon: 'PhPlant',
    info: 'Đơn vị ký sinh không trực tiếp tấn công nhưng chuyên hỗ trợ đồng minh.',
    attackPattern: 'Lao thẳng vào lính gần nhất để ký sinh, biến thành bộ giáp mang lõi Tốc Độ, Hồi Phục hoặc Cuồng Nộ.',
    counters: 'Biến một con quái thường thành phiên bản tinh anh vô cùng nguy hiểm.',
    expDrop: '3-5 orb tím/vàng (~80-140 EXP).',
    tips: [
      'Bắn hạ Thổ nhưỡng trước khi nó kịp bám vào vật chủ.',
      'Khi tiêu diệt được vật chủ, Thổ nhưỡng sẽ bị phá huỷ theo.',
    ],
    stats: { hp: 35, speed: 85, damage: 15, threat: 85 },
    phases: [
      { title: 'Tìm chủ', desc: 'Lao với tốc độ cao về phía kẻ thù khác.', art: 'dnox_soil_seek' },
      { title: 'Ký sinh', desc: 'Hợp thể và buff chỉ số cực mạnh cho quái.', art: 'dnox_soil_buff' },
    ],
  },
]
